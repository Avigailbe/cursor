...
--3. show contact name in 2 different columns fisrt and last names
...
--4. show employees. before each line, 5 second delay
...
--5. show database objects that are type = date
...
--6. script or procedure thats gets a parameter as varchar with following details:
-- tableName, firstColumnName, firstColumnDataType
